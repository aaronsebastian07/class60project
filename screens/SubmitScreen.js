  ...
  render() {
    return (
      <View style={{ flex: 1 }}>
        ...
        <Text style={styles.le}>Present Students List</Text>
        ...
        <Text style={styles.tit}>Absent Students List</Text>
        ...
        <View style={{flex:0.1, flexDirection:'row', justifyContent:'space-around'}}>
          <Text style={styles.pre}>Present: {this.state.present_students.length}</Text>
          <Text style={styles.abs}>Absent: {this.state.absent_students.length}</Text>
        </View>
      </View>
    );
  }
